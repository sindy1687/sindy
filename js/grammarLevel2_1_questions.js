...
const UNIFIED_QUESTION_BANK = {
  easy: [
        ...
        },
        {
            ...
            difficultWords: ["teacher", "available"]
        },
        {
            ...
            difficultWords: ["chairs", "comfortable"]
        },
        {
        ...
        },
        {
            ...
            difficultWords: ["books", "interesting"]
        },
        {
        ...
        },
        {
            ...
            difficultWords: ["neighbors", "noisy"]
        },
        {
        ...
        },
        {
            ...
            difficultWords: ["paintings", "modern"]
        },
        {
        ...
        },
        {
            ...
            difficultWords: ["classmates", "present"]
        },
        {
        ...
        },
        {
            ...
            difficultWords: ["subject", "difficult"]
        }
  ],
  medium: [
        { question: "My parents ___ at work now.", options: ["am not", "is not", "are not", "be not"], correct: 2, explanation: "My parents 是複數，否定要用 are not。（父母）", logicHint: "主詞 My parents 是複數，後面要接什麼呢?", difficultWords: ["parents", "work"] },
        ...
        { question: "This soup ___ hot enough.", options: ["am not", "is not", "are not", "be not"], correct: 1, explanation: "This soup 是單數，否定要用 is not。（湯）", logicHint: "主詞 This soup 是單數，後面要接什麼呢?", difficultWords: ["soup", "hot"] },
        ...
        { question: "The buses ___ on time today.", options: ["am not", "is not", "are not", "be not"], correct: 2, explanation: "The buses 是複數，否定要用 are not。（巴士）", logicHint: "複數名詞否定要用 are not。", difficultWords: ["buses"] },
        ...
        { question: "You ___ the only one here.", options: ["am not", "is not", "are not", "be not"], correct: 2, explanation: "You 是第二人稱，否定要用 are not。（你）", logicHint: "You 是第二人稱，否定要用 are not。", difficultWords: [] },
        { question: "The movie ___ very exciting.", options: ["am not", "is not", "are not", "be not"], correct: 1, explanation: "The movie 是單數，否定要用 is not。（電影）", logicHint: "單數名詞否定要用 is not。", difficultWords: ["movie", "exciting"] },
        { question: "We ___ from the same city.", options: ["am not", "is not", "are not", "be not"], correct: 2, explanation: "We 是複數，否定要用 are not。（我們）", logicHint: "We 是複數，否定要用 are not。", difficultWords: ["city"] },
        { question: "It ___ a good idea.", options: ["am not", "is not", "are not", "be not"], correct: 1, explanation: "It 是第三人稱單數，否定要用 is not。（它）", logicHint: "It 是第三人稱單數，否定要用 is not。", difficultWords: ["idea"] },
        {
